...
describe('CheckoutBillingComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [CheckoutBillingComponent, AddressFormComponent],
  ...
  describe('getSavedAddresses', () => {
    ...
    it('should call ListAddresses with billing filter', () => {
  ...
  describe('setSelectedAddress', () => {
    it('should select address from order', () => {
  ...
  describe('setOneTimeAddress', () => {
    it('should call orderService.SetBillingAddress', () => {
  ...
  describe('setSavedAddress', () => {
    it('should patch order.BillingAddressID', () => {
